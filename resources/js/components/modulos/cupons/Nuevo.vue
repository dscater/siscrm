                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <label
                                    ...
                                    >Porcentaje de descuento (1-100)*</label
                                >
                                <input
                                    type="numeric"
    ...
    methods: {
        setRegistroModal() {
            ...
            try {
                ...
                formdata.append(
                    "texto",
                    this.cupon.texto ? this.cupon.texto : ""
                );
                formdata.append(
                    "descuento",
                    this.cupon.descuento ? this.cupon.descuento : ""
                );

                if (this.accion == "edit") {
                    url = "/admin/cupons/" + this.cupon.id;
